...
public class Attribute implements Map.Entry<String, String>, Cloneable  {
     ...
     */
    public String html() {
        return key + "=\"" + Entities.escape(value, (new org.jsoup.nodes.Document("")).outputSettings()) + "\"";
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof org.jsoup.nodes.Attribute)) return false;
    ...
    public org.jsoup.nodes.Attribute clone() {
        try {
            return (org.jsoup.nodes.Attribute) super.clone(); // only fields are immutable strings key and value, so no more deep copy required
