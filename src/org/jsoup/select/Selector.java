 ...
 * <tr><td><code>:not(<em>selector</em>)</code></td><td>elements that do not match the <em>selector</em>. See also {@link org.jsoup.select.Elements#not(String)}</td><td><code>div:not(.logo)</code> finds all divs that do not have the "logo" class.<br /><code>div:not(:has(div))</code> finds divs that do not contain divs.</code></td></tr>
 * <tr><td><code>:contains(<em>text</em>)</code></td><td>elements that contains the specified text. The search is case insensitive. The text may appear in the found element, or any of its descendants.</td><td><code>p:contains(org.jsoup)</code> finds p elements containing the text "org.jsoup".</td></tr>
 * <tr><td><code>:matches(<em>regex</em>)</code></td><td>elements whose text matches the specified regular expression. The text may appear in the found element, or any of its descendants.</td><td><code>td:matches(\\d+)</code> finds table cells containing digits. <code>div:matches((?i)login)</code> finds divs containing the text, case insensitively.</td></tr>
 * <tr><td><code>:containsOwn(<em>text</em>)</code></td><td>elements that directly contain the specified text. The search is case insensitive. The text must appear in the found element, not any of its descendants.</td><td><code>p:containsOwn(org.jsoup)</code> finds p elements with own text "org.jsoup".</td></tr>
...
public class Selector {
     ...
     */
    public static org.jsoup.select.Elements select(String query, Element root) {
     ...
     * @return matching elements, empty if not
     */
    public static org.jsoup.select.Elements select(String query, Iterable<Element> roots) {
        Validate.notEmpty(query);
    ...
    static org.jsoup.select.Elements filterOut(Collection<Element> elements, Collection<Element> outs) {
        org.jsoup.select.Elements output = new Elements();
