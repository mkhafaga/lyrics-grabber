...
/**
 A list of {@link org.jsoup.nodes.Element Elements}, with methods that act on every element in the list.
 <p/>
 To get an Elements object, use the {@link org.jsoup.nodes.Element#select(String)} method.
...
public class Elements implements List<Element>, Cloneable {
     ...
     * @return this
     */
    public org.jsoup.select.Elements attr(String attributeKey, String attributeValue) {
        for (Element element : contents) {
     ...
     */
    public org.jsoup.select.Elements removeAttr(String attributeKey) {
        for (Element element : contents) {
    ...
    /**
     ...
     @return this
     */
    public org.jsoup.select.Elements addClass(String className) {
        for (Element element : contents) {
    ...
    /**
     ...
     @return this
     */
    public org.jsoup.select.Elements removeClass(String className) {
        for (Element element : contents) {
    ...
    /**
     ...
     @return this
     */
    public org.jsoup.select.Elements toggleClass(String className) {
        for (Element element : contents) {
     ...
     * @see org.jsoup.nodes.Element#val()
     */
    public String val() {
        if (size() > 0)
            return first().val();
     ...
     * @return this (for chaining)
     */
    public org.jsoup.select.Elements val(String value) {
        for (Element element : contents)
            element.val(value);
        return this;
    }
     ...
     * @return this, for chaining
     * @see org.jsoup.nodes.Element#tagName(String)
     */
    public org.jsoup.select.Elements tagName(String tagName) {
        for (Element element : contents) {
     ...
     * @return this, for chaining
     * @see org.jsoup.nodes.Element#html(String)
     */
    public org.jsoup.select.Elements html(String html) {
        for (Element element : contents) {
            element.html(html);
        }
        return this;
     ...
     * @return this, for chaining
     * @see org.jsoup.nodes.Element#prepend(String)
     */
    public org.jsoup.select.Elements prepend(String html) {
        for (Element element : contents) {
     ...
     * @return this, for chaining
     * @see org.jsoup.nodes.Element#append(String)
     */
    public org.jsoup.select.Elements append(String html) {
        for (Element element : contents) {
            element.append(html);
        }
        return this;
     ...
     * @return this, for chaining
     * @see org.jsoup.nodes.Element#before(String)
     */
    public org.jsoup.select.Elements before(String html) {
        for (Element element : contents) {
            element.before(html);
        }
        return this;
     ...
     * @return this, for chaining
     * @see org.jsoup.nodes.Element#after(String)
     */
    public org.jsoup.select.Elements after(String html) {
        for (Element element : contents) {
            element.after(html);
        }
        return this;
    ...
    /**
     ...
     becomes {@code <p><i><b>This</b></i> is <i><b>org.jsoup</b></i></p>}
     @param html HTML to wrap around each element, e.g. {@code <div class="head"></div>}. Can be arbitrarily deep.
     @return this (for chaining)
     @see org.jsoup.nodes.Element#wrap
     */
    public org.jsoup.select.Elements wrap(String html) {
     ...
     *
     * @return this (for chaining)
     * @see org.jsoup.nodes.Node#unwrap
     */
     ...
     * @return this, for chaining
     * @see org.jsoup.nodes.Element#empty()
     * @see #remove()
     */
     ...
     * @param query A {@link org.jsoup.select.Selector} query
     * @return the filtered list of elements, or an empty list if none match.
     */
    public org.jsoup.select.Elements select(String query) {
        return Selector.select(query, this);
    }

    /**
     * Remove elements from this list that match the {@link org.jsoup.select.Selector} query.
     * <p>
     ...
     */
    public org.jsoup.select.Elements not(String query) {
        org.jsoup.select.Elements out = Selector.select(query, this);
    ...
    public org.jsoup.select.Elements eq(int index) {
        return contents.size() > index ? new org.jsoup.select.Elements(get(index)) : new org.jsoup.select.Elements();
    }
     ...
     * @return this, for chaining
     */
    public org.jsoup.select.Elements traverse(NodeVisitor nodeVisitor) {
