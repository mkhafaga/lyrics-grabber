...
enum TokeniserState {
    Data {
        ...
        void read(Tokeniser t, org.jsoup.parser.CharacterReader r) {
            switch (r.current()) {
                case '&':
    ...
    RCDATAEndTagName {
        ...
        private void anythingElse(Tokeniser t, org.jsoup.parser.CharacterReader r) {
    ...
    abstract void read(Tokeniser t, org.jsoup.parser.CharacterReader r);
