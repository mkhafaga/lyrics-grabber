...
public class Parser {
     ...
     */
    public org.jsoup.parser.Parser setTreeBuilder(TreeBuilder treeBuilder) {
        this.treeBuilder = treeBuilder;
        return this;
    }
    ...
    public static Document parse(String html, String baseUri) {
        TreeBuilder treeBuilder = new org.jsoup.parser.HtmlTreeBuilder();
    ...
    public static String unescapeEntities(String string, boolean inAttribute) {
        Tokeniser tokeniser = new Tokeniser(new CharacterReader(string), org.jsoup.parser.ParseErrorList.noTracking());
