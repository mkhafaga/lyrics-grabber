...
class Tokeniser {
    ...
    private org.jsoup.parser.CharacterReader reader; // html input
    private org.jsoup.parser.ParseErrorList errors; // errors found while tokenising

    private org.jsoup.parser.TokeniserState state = org.jsoup.parser.TokeniserState.Data; // current tokenisation state
    private org.jsoup.parser.Token emitPending; // the token we are about to emit on next read
    ...
    org.jsoup.parser.Token.Tag tagPending; // tag we are building up
    org.jsoup.parser.Token.Doctype doctypePending; // doctype building up
    org.jsoup.parser.Token.Comment commentPending; // comment building up
    private org.jsoup.parser.Token.StartTag lastStartTag; // the last start tag emitted, to test appropriate end tag
