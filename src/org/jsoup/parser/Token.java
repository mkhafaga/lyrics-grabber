...
abstract class Token {
    ...
    static class Doctype extends org.jsoup.parser.Token {
        ...
        Doctype() {
            type = org.jsoup.parser.Token.TokenType.Doctype;
        }
    ...
    static abstract class Tag extends org.jsoup.parser.Token {
        ...
        org.jsoup.parser.Token.Tag name(String name) {
            tagName = name;
            return this;
        }
    ...
    static class StartTag extends Tag {
        StartTag() {
            super();
            attributes = new Attributes();
            type = org.jsoup.parser.Token.TokenType.StartTag;
        }
    ...
    static class EndTag extends Tag{
        EndTag() {
            super();
            type = org.jsoup.parser.Token.TokenType.EndTag;
        }
    ...
    static class Comment extends org.jsoup.parser.Token {
        final StringBuilder data = new StringBuilder();
        boolean bogus = false;

        Comment() {
            type = org.jsoup.parser.Token.TokenType.Comment;
        }
    ...
    static class Character extends org.jsoup.parser.Token {
        private final String data;

        Character(String data) {
            type = org.jsoup.parser.Token.TokenType.Character;
            this.data = data;
        }
    ...
    static class EOF extends org.jsoup.parser.Token {
        EOF() {
            type = org.jsoup.parser.Token.TokenType.EOF;
        }
    }
